...
//     let keygen_payload = crate::enclave::validator::attest_fresh_bls_key(
...
//         crate::enclave::guardian::handlers::validate_custody::generate_signature(
//             keygen_payload,
//             0,
